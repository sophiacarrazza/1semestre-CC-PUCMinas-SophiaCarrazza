...
fetch('https://diwserver.vps.webdock.cloud/products').then((data)=>{
    return data.json();

}).then((completedata)=>{

    let data1 = "";
    var completedata = completedata.products;
...
fetch('https://diwserver.vps.webdock.cloud/products?limit=9')
  .then(function(response) {
    return response.json();
  })
  .then(function(data) {
    var completedata = data.products;
